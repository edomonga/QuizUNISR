        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8">
            {resetSent ? (
              ...
              <>
                <h2 className="text-xl font-semibold text-[rgb(32,44,71)] mb-2">Password dimenticata?</h2>
                <p className="text-xs text-gray-400 mb-5">
                  Inserisci la tua email universitaria e ti invieremo un link per reimpostare la password.
                </p>
                <form onSubmit={handleReset} className="space-y-4">
                  <div>
                    ...
                    <input
                      ...
                      placeholder="nome@studenti.unisr.it"
                      required
                      autoFocus
                    />
                  </div>
